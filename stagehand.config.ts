...
const StagehandConfig: ConstructorParams = {
  ...
  browserbaseSessionCreateParams: {
    ...
    browserSettings: { /* These settings are needed for detecting the captcha on the ticket website */
      viewport: {
        width: 1280,
        height: 800,
      },
      // @ts-ignore
      captchaImageSelector: "#captcha",
      // @ts-ignore
      captchaInputSelector:
        "body > div > table > tbody > tr > td:nth-child(1) > form > table:nth-child(11) > tbody > tr:nth-child(2) > td > input",
    },
  },
